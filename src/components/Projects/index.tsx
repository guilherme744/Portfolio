                ...
                <div key={i} className="rounded-lg bg-gradient-custom p-[1px]">
                    <div className=" rounded-lg bg-back p-8 max-lg:p-6 max-xs:p-4">
                        ...
                        <div className="flex justify-between gap-4 max-lg:gap-2">
                            {item.linkPreview && (
                                <Link className="flex-1 grow-[1] rounded-full bg-gradient-custom px-2 py-4 text-center text-sm shadow-md shadow-blue-500/50 transition-all hover:shadow-lg hover:shadow-blue-500/50 max-lg:p-3 max-lg:text-xs" target="_blank" href={item.linkPreview}>Live preview</Link>
                            )}
