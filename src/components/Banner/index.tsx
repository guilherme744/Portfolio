                ...
                <div className="group relative w-full pt-20 max-lg:mb-20 max-lg:pt-6 max-md:pt-0">
                    <div className="relative z-40 flex flex-col gap-10 max-lg:my-10 max-lg:gap-5">
                        <h1 className="flex flex-col items-start gap-4 text-6xl font-semibold max-lg:gap-2 max-lg:text-4xl max-xs:gap-2 max-xs:text-3xl">
                            <span className="bg-gradient-custom bg-clip-text text-transparent">Guilherme</span>
                            <span>Senior Full Stack Developer</span>
                        </h1>
                        <p className="max-w-2xl tracking-wide text-coldGrey max-xs:text-sm">Turning Ideas into Digital Reality: Guilherme, a Full Stack Developer passionate about crafting elegant and functional interfaces to deliver exceptional user experiences.</p>
